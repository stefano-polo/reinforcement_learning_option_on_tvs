...
\title{Reinforcement learning for options\\on target volatility funds\thanks{Supported by ISCRA from Cineca, \email{iscra@cineca.it}.}}
...
\email{Emanuele.Nastasi@marketz.eu} \and Financial Engineering,
