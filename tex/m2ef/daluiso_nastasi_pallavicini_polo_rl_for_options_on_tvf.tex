...
Our aim is to find the most expensive investing strategy from the point of view of financing costs for the \remove{bank} \change{writer} that the manager could choose in the market. In other words, we want to determine the worst-case scenario for the bank. In the current section, we proceed by defining the price process of the TVS so that we can highlight the impact of valuation adjustments.
